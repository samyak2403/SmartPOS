...
import com.app.smartpos.report.SalesReportActivity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cardLocalBackUp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String outFileName = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS)  + "/SmartPos/";
            ...
            public void onCompleted(String filePath) {
                ...
                mHand.postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        loading.dismiss();
                        Toasty.success(BackupActivity.this, getString(R.string.data_successfully_exported)+". Checked at "+path, Toast.LENGTH_SHORT).show();
